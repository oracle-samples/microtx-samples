...
public class FlightResource {
    ...
    @Post(uri = "/flight", consumes = MediaType.APPLICATION_FORM_URLENCODED)
    @LRA(value = LRA.Type.MANDATORY, end = false)
    public HttpResponse<?> bookRoom(@Header(LRA_HTTP_CONTEXT_HEADER) String lraId,
                                    @QueryValue(value = "flightNumber") String flightNumber){
    ...
    public HttpResponse<?> completeWork(@Header(LRA_HTTP_CONTEXT_HEADER) String lraId){
        ...
        if(booking == null){
            return HttpResponse.notFound().body("Flight booking not found");
        }
