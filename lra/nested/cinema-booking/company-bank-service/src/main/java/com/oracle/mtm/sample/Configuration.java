...
public class Configuration {
    ...
    @Inject
    @ConfigProperty(name = "serviceDataSource.url")
    String url;
    @Inject
    @ConfigProperty(name = "serviceDataSource.user")
    String user;
    @Inject
    @ConfigProperty(name = "serviceDataSource.password")
    String password;
    ...
    private void initialiseDataSource() {
        try {
            ...
            this.getLogger().log(Level.SEVERE, "Failed to initialise database");
        }
    }
    ...
    /**
     * Initialise the logger instance and logging level for TRM library
     *
     */
    private void initialiseTrmLogger() {
        this.logger = Logger.getLogger(MethodHandles.lookup().lookupClass().getName());
//        TrmConfig.initLogging(this.logger, Level.INFO);
    }
