...
//        ServiceInstance serviceInstance = discoveryClient.getInstances("hotel-service").get(0);
//        LOG.info("hotel-service host is: " + serviceInstance.getUri());
        return UriComponentsBuilder.fromUri(URI.create(hotelServiceUri));
    }

    private UriComponentsBuilder getFlightTarget(){
//        ServiceInstance serviceInstance = discoveryClient.getInstances("flight-service").get(0);
//        LOG.info("flight-service host is: " + serviceInstance.getUri());
