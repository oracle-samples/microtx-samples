...
*/
package com.oracle.tmm.branchbanking;
...
public class DatasourceConfigurations {
    ...
    @Value("${branch-datasource.url}")
    private String url;

    @Value("${branch-datasource.user}")
    private String username;

    @Value("${branch-datasource.password}")
    private String password;

    @Value("${branch-datasource.oracleucp.initial-pool-size}")
    private String initialPoolSize;

    @Value("${branch-datasource.oracleucp.min-pool-size}")
    private String minPoolSize;

    @Value("${branch-datasource.oracleucp.max-pool-size}")
    private String maxPoolSize;

    @Value("${branch-datasource.oracleucp.connection-driver-factory-class-name:oracle.jdbc.pool.OracleDataSource}")
    private String connectionFactoryClassName;

    @Value("${branch-datasource.oracleucp.xa-connection-driver-factory-class-name:oracle.jdbc.xa.client.OracleXADataSource}")
    ...
    /**
     * XA datasource bean for branch distributed transactions
     */
    @Bean(name = "BRPoolXADataSource")
    @Primary
    public PoolXADataSource getXAPoolDataSource() {
        ...
        try {
            ...
            logger.info("XADataSourceConfig: XADataSource initialized successfully");
        } catch (SQLException ea) {
            log.error("Error connecting to the database: {}", ea.getMessage());
        }
        return xapds;
