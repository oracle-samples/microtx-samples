...
exports.MeterBarWebElement = MeterBarWebElement_1.MeterBarWebElement;
/**
 * Retrieve an instance of [[MeterBarWebElement]].
 * @example
 * ```javascript
 ...
 */
function findMeterBar(driver, by) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    webEl = _a.sent();
                    if (!!(webEl instanceof MeterBarWebElement_1.MeterBarWebElement)) return [3 /*break*/, 3];
                    return [4 /*yield*/, webEl.getTagName()];
                case 2:
                    tagName = _a.sent();
                    throw Error("findMeterBar(".concat(by, ") created ").concat(webEl.constructor.name, " for <").concat(tagName, ">, but expected ").concat(MeterBarWebElement_1.MeterBarWebElement.name));
