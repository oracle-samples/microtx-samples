...
exports.SplitMenuButtonWebElement = SplitMenuButtonWebElement_1.SplitMenuButtonWebElement;
/**
 ...
 */
function findSplitMenuButton(driver, by) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    webEl = _a.sent();
                    if (!!(webEl instanceof SplitMenuButtonWebElement_1.SplitMenuButtonWebElement)) return [3 /*break*/, 3];
                    return [4 /*yield*/, webEl.getTagName()];
                case 2:
                    tagName = _a.sent();
                    throw Error("findSplitMenuButton(".concat(by, ") created ").concat(webEl.constructor.name, " for <").concat(tagName, ">, but expected ").concat(SplitMenuButtonWebElement_1.SplitMenuButtonWebElement.name));
