...
*/
package com.oracle.tmm.stockbroker;
...
public class DatasourceConfigurations {
    ...
    @Value("${stockbroker-datasource.url}")
    private String url;

    @Value("${stockbroker-datasource.user}")
    private String username;

    @Value("${stockbroker-datasource.password}")
    private String password;

    @Value("${stockbroker-datasource.oracleucp.initial-pool-size}")
    private String initialPoolSize;

    @Value("${stockbroker-datasource.oracleucp.min-pool-size}")
    private String minPoolSize;

    @Value("${stockbroker-datasource.oracleucp.max-pool-size}")
    private String maxPoolSize;

    @Value("${stockbroker-datasource.oracleucp.connection-driver-factory-class-name:oracle.jdbc.pool.OracleDataSource}")
    private String connectionFactoryClassName;

    @Value("${stockbroker-datasource.oracleucp.xa-connection-driver-factory-class-name:oracle.jdbc.xa.client.OracleXADataSource}")
