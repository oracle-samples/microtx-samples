...
Copy `oracle-microtx-26.1.1.tgz` file from `<distribution-package-dir>/lib/nodejs` to the travel-agent folder.

```
cp <distribution-package-dir>/lib/nodejs/oracle-microtx-26.1.1.tgz ./
```
