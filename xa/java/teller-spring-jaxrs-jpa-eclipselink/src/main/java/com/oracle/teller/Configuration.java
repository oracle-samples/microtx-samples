...
import com.oracle.teller.resource.TransferResource;
...
//    @Value("${departmentDataSource.url}") String url;
//    @Value("${departmentDataSource.user}") String user;
//    @Value("${departmentDataSource.password}") String password;
}