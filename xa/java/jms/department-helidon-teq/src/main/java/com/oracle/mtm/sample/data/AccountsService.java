...
public class AccountsService implements IAccountsService {
    ...
    @Override
    public void publishEvent(String accountId, double amount) throws JMSException, SQLException {
        ...
        try (AQjmsTopicPublisher publisher = (AQjmsTopicPublisher) ((AQjmsSession) xaTopicSession).createPublisher(topic)) {
            String msg = "Deposited: " + amount + " in account: " + accountId;
