...
public class XADataSourceConfig {
    ...
    public EntityManagerFactory createEntityManagerFactory() throws SQLException {
        ...
        MicroTxConfig.initEntityManagerFactory(emf, dataSourceName, feeRmid); // Initialize TMM Library
        return emf;
    }
    ...
    public EntityManagerFactory createCreditEntityManagerFactory() throws SQLException {
        ...
        properties.setProperty( "jakarta.persistence.transactionType", "RESOURCE_LOCAL"); // change this to resource_local
        properties.setProperty("jakarta.persistence.jdbc.driver", "oracle.jdbc.OracleDriver");
        properties.setProperty("jakarta.persistence.jdbc.url", creditUrl);
        properties.setProperty("jakarta.persistence.jdbc.user", creditUsername);
        properties.setProperty("jakarta.persistence.jdbc.password", creditPassword);
