...
*/
package com.example.mtm.sample.service;
...
public class BankingServiceImpl implements BankingService {
    ...
    @Async(value = "microTxTaskExecutor")
    @Override
    public CompletableFuture withdraw(double amount, String accountId) {
        ...
        try {
            ...
            throw new TransferFailedException("Deposit failed: " + e.getMessage());
        }
    ...
    @Async(value = "microTxTaskExecutor")
    @Override
    public CompletableFuture deposit(double amount, String accountId) {
        ResponseEntity<String> responseEntity = null;
        try {
            ...
            LOG.error("Deposit failed with exception: {}", e.getMessage());
            throw new TransferFailedException("Deposit failed: " + e.getMessage());
        }
        return CompletableFuture.completedFuture(responseEntity);
    }
