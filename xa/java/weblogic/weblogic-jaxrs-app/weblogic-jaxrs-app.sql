...
*/
CREATE USER department_weblogic IDENTIFIED BY <password> QUOTA UNLIMITED ON DATA;
GRANT CREATE SESSION TO department_weblogic;
ALTER SESSION SET CURRENT_SCHEMA=department_weblogic;
