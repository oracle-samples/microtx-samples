...
public class TransferFeeService {
    ...
    public TransferFeeService(ApplicationContext applicationContext) {
        ...
        try {
            feeEntityManager =  (EntityManager) applicationContext.getBean("microTxEntityManager", "feeDataSource");
    ...
    public Fee accountDetails(String accountId) throws SQLException {
        Fee fee = feeRepository.findByAccountId(accountId,feeEntityManager);
        return fee;
    }
