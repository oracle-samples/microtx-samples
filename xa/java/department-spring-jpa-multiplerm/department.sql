...
*/
CREATE USER department_spring_jpa IDENTIFIED BY <password> QUOTA UNLIMITED ON DATA;
GRANT CREATE SESSION TO department_spring_jpa;
ALTER SESSION SET CURRENT_SCHEMA=department_spring_jpa;
