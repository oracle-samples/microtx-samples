...
public class DataSourceConfig {
    ...
    @Value("${oracleucp.non-xa.connection-pool-name:nonxaConnectionPool}")
    ...
    @Value("${database.ucp.data-source-name:UCPDatasourceNonXA}")
    ...
    public void initializeMicroTx(DataSource xaDataSource) {
        ...
        // configuration.addMapper(AccountMapperXA.class);
