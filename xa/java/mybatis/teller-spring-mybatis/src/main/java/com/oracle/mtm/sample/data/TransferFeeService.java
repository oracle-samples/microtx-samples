...
public class TransferFeeService {
    ...
    public boolean depositFee(String accountId, double amount) throws SQLException {
        ...
        try(MicroTxSqlSession session = (MicroTxSqlSession) sqlSession) {
            FeeMapperXA feeMapper = session.getMapper(FeeMapperXA.class);
            int rowsAffected = feeMapper.depositFee(accountId, amount);
    ...
    public Fee feeDetails(String accountId) throws SQLException {
        ...
        try (SqlSession session = sqlSessionFactory.openSession()) {
            FeeMapperNonXA feeMapper = session.getMapper(FeeMapperNonXA.class);
            feeDetails = feeMapper.findByAccountId(accountId);
        }
        return feeDetails;
    }
}