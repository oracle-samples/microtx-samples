...
public class DataSourceConfig {
    ...
    public DataSource getXADataSource() {
        ...
        try {
            ...
            logger.error("Error while initializing XA datasource: " + ex.getMessage());
        }
        return pds;
    }

    public void initializeMicroTx(DataSource xaDataSource) throws IOException {
        ...
        InputStream inputStream = Resources.getResourceAsStream("mappers/FeeMapperXA.xml");
        XMLMapperBuilder xmlMapperBuilder = new XMLMapperBuilder(inputStream, configuration, "mappers/FeeMapperXA.xml", null);
