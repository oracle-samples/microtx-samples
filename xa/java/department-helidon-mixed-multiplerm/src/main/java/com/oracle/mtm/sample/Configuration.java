...
public class Configuration {
    ...
    private void initialiseDataSource() {
        ...
        try {
            ...
            this.creditDataSource.setConnectionFactoryClassName("com.mysql.cj.jdbc.MysqlDataSource");
            this.creditDataSource.setMaxPoolSize(15);
            TrmConfig.initNonXaDataSource(this.creditDataSource,creditDataSouceInfo);
        } catch (SQLException e) {
