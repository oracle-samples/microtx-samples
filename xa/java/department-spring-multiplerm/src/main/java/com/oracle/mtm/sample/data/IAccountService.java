...
public interface IAccountService {
    ...
    /**
     * Get credit RM account details persisted in the database
     * @param accountId Account identity
     * @return Returns the account details associated with the account
     * @throws SQLException
     */
    Account creditAccountDetails(String accountId) throws SQLException;
     ...
     * @throws SQLException
     */
    boolean increaseCreditPoint(String accountId, double amount) throws SQLException;
}
